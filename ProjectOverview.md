...
- 41 specialized agents across code analysis, test generation, traceability, code-generation & fixes, commit analysis, and security (latest phase shipped: **Phase 6 Wave 6B**)
  ...
  - **Phase 6 Wave 6B (4 agents):** Self-Healing Test Agent (F9), SonarQube Fix Automation (F11), NL→SQL Generator (F14), Auto-Fix Patch Generator (F15) — all four share `tools/patch_emitter.py` for deterministic unified-diff output
...
OrchestratorAgent (agents/orchestrator.py)
  ...
  Phase 6 Wave 6B: self_healing_agent (F9) | sonar_fix_agent (F11)
                   sql_generator (F14) | auto_fix_agent (F15)
  ...
  Wave 6B tools:  patch_emitter (shared across all 4 Wave 6B agents)
                  sonar_fetcher (F11) | ddl_parser (F14)
       ↕
